...
func (s *AddCollectionReq) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
func (s *AddCollectionReq) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("name")
		e.Str(s.Name)
	}
...
var jsonFieldsNameOfAddCollectionReq = [2]string{
	0: "name",
	1: "description",
}

// Decode decodes AddCollectionReq from json.
func (s *AddCollectionReq) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AddCollectionReq to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode AddCollectionReq")
	}
	...
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAddCollectionReq) {
					name = jsonFieldsNameOfAddCollectionReq[fieldIdx]
				} else {
...
func (s *AddCollectionReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
func (s *AddCollectionReq) UnmarshalJSON(data []byte) error {
...
var jsonFieldsNameOfCollection = [4]string{
	0: "id",
	1: "name",
	2: "description",
	3: "created",
...
// Encode encodes AddCollectionReq as json.
func (o OptAddCollectionReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
// Decode decodes AddCollectionReq from json.
func (o *OptAddCollectionReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptAddCollectionReq to nil")
	}
	o.Set = true
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptAddCollectionReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptAddCollectionReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode encodes UpdatePageReq as json.
func (o OptUpdatePageReq) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	o.Value.Encode(e)
...
func (o *OptUpdatePageReq) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptUpdatePageReq to nil")
	}
	o.Set = true
	if err := o.Value.Decode(d); err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptUpdatePageReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptUpdatePageReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfPage = [9]string{
	0: "id",
	1: "url",
	2: "created",
	3: "collection_id",
...
var jsonFieldsNameOfPageWithResults = [10]string{
	0: "id",
	1: "url",
	2: "created",
	3: "collection_id",
...
// Encode implements json.Marshaler.
func (s *UpdatePageReq) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *UpdatePageReq) encodeFields(e *jx.Encoder) {
	{
		if s.Title.Set {
			e.FieldStart("title")
			s.Title.Encode(e)
...
// Decode decodes UpdatePageReq from json.
func (s *UpdatePageReq) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UpdatePageReq to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode UpdatePageReq")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *UpdatePageReq) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *UpdatePageReq) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
